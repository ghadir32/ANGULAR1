...
phoneandmore.controller('stocksController', ['$scope', '$http', function($scope, $http){
   ...
   //get all products from the database
    $http({
        method: 'get', 
        url: 'http://localhost/angular%20training%201/ws/ws_products.php?op=1'
    ...
    $scope.edit = function(event){
        ...
        $http({
            method: 'GET', 
            url: 'http://localhost/angular%20training%201/ws/ws_products.php?op=2',
    ...
    $scope.AddOrEdit = function(){
        if($scope.btnVal == "Add item"){
                ...
                $http({
                    url: 'http://localhost/angular%20training%201/ws/ws_products.php?op=3',
                    method: "POST",
                    params: {
                            name: $scope.pname,
            ...
            $http({
                url: 'http://localhost/angular%20training%201/ws/ws_products.php?op=5',
                method: "POST",
                params: {
                        id: $scope.pid,
                        name: $scope.pname,
    ...
    $scope.delItem = function(idd){
        ...
        $http({
            url: 'http://localhost/angular%20training%201/ws/ws_products.php?op=4',
            method: "POST",
            params: {
                    id: idd
            }, 
...
phoneandmore.controller('sellController', ['$scope', function($scope){
    $scope.nam = 'test selll';
